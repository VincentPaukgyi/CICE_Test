#pragma checksum "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\RSACrypto.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "E2B5AFE15425D3D109B8A81979F70A29D1F21A93"

#line 1 "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\RSACrypto.cs"
using System;
 ...
 public class RSACrypto
    {
        public static String EncryptData(String originalData)
        {
            ...
            rsaCsp = readPublicKeyFromFile(ConfigurationManager.AppSettings["MyKyatpublicKey"].ToString());
        ...
        public static String DecryptData(String encryptedData, string checkSum)
        {
            ...
            if (return_check_sum_value == checkSum)
            {
                ...
                rsaCsp = CreateRsaProviderFromPrivateKey(key);

                byte[] ciphertext = rsaCsp.Decrypt(decodedResult, false);
               
                string returnValue = System.Text.Encoding.UTF8.GetString(ciphertext);
