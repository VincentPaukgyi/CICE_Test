#pragma checksum "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\BillModel.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7C0C59637C4FB2BBB38C80F33F7579F09E12C950"

#line 1 "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\BillModel.cs"
using System;
...
public class giftCardConfirmRes
{
 public string ExpiryDate { get; set; }
    ...
    //    public string billerlog { get; set; }
    //    public string billername { get; set; }
    //    public string ref1 { get; set; }
    //    public string ref2 { get; set; }
    //    public string ref3 { get; set; }
...
#region 4TV
    ...
    public class CanalPlusViewerListRes
    {
    ...
    public class CanalPlusPackagesRes
    {
        public string CardNumber { get; set; }
        public string IDBase { get; set; }
        public string SubscriberNumber { get; set; }
    ...
    public class CanalPlusChangePackageVerifyRes
    {
        public string CardNumber { get; set; }
        public string IDBase { get; set; }
        public string SubscriberNumber { get; set; }
    ...
    public class fuorTVSubscribeRes
    {
        ...
        //    "message": "",
        //    "response": {
        //        "expire_date": "2017-10-18 23:59:00"
        //    }
        //}
        public int status { get; set; }
        public string message { get; set; }
    ...
    public class CanalPlusSubscribeRes
    {
        public string CanalPlusTransactionID { get; set; }
        public string CardNumber { get; set; }
        public string idBase { get; set; }
        public string SubscriberNumber { get; set; }
        public string ContractNumber { get; set; }
    ...
    public class CanalPlusChangePackageConfirmRes
    {
        public string CardNumber { get; set; }
