#pragma checksum "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\Utils.cs" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7AE7A855FA8B61565A44ADAAC072E8FD70730221"

#line 1 "D:\2C2P\Alternative-Payment-Network\BIS\BIS\App_Code\Utils.cs"
using System;
...
//Secret Key(Test) : 746D7SCHAIQ0QUZ0MRJWU0PQ3AD7PJ8B
   ...
   // msgid, agnid, rescode, resdesc, ref3, ref1, expiry,amt
    ...
    public static string ReadJson(string jsonRoot, string key, string option, string strJson)
    {
        ...
        //return tempstr.Replace("'","''").ToString();
        return tempstr;
    }
    ...
    public static string getChangePackageConfirmRes(EBACanalPlusChangePackageConfirmRes confirmRes)
    {
        ...
        sb.Append("<PackageCode>" + confirmRes.Package[0].Code + "</PackageCode>");
        sb.Append("<PackageLabel>" + confirmRes.Package[0].Label + "</PackageLabel>");
        ...
        sblog.Append("<PackageCode>" + confirmRes.Package[0].Code + "</PackageCode>");
        sblog.Append("<PackageLabel>" + confirmRes.Package[0].Label + "</PackageLabel>");
    ...
    public static string getChangePackagesInquiryResCanalPlus(inquiryPackagesResponseModelCanalPlus inqueryRes)
    {
        StringBuilder sbLog = new StringBuilder();
        StringBuilder sb = new StringBuilder();
        ...
        foreach (Package package in inqueryRes.ResponsePackage)
        {
            sb.Append("<Package>");
            sb.Append("<Code>" + package.Code + "</Code>");
            sb.Append("<Label>" + package.Label + "</Label>");
            sb.Append("<Durations>");
            foreach (Duration duration in package.Duration)
            {
        ...
        sb.Append("</Packages>");
        sb.Append("<SessionID>" + inqueryRes.SessionID + "</SessionID>");
        sb.Append("</GetCanalPlusPackagesRes>");
        return sb.ToString();
    }

    public static string getChangePackageVerifyInquiryResCanalPlus(inquiryChangePackageVerifyResponseModelCanalPlus inqueryRes)
    {
        StringBuilder sbLog = new StringBuilder();
        StringBuilder sb = new StringBuilder();
        ...
        sb.Append("<Ref4Name>" + inqueryRes.ref4Name + "</Ref4Name>");
        sb.Append("<Ref5Name>" + inqueryRes.ref5Name + "</Ref5Name>");
        //sb.Append("<IDBase>" + inqueryRes.ref5Name + "</IDBase>");
        //sb.Append("<ContractNumber>" + inqueryRes.ContractNumber + "</ContractNumber>");
        sb.Append("<PackageCode>" + inqueryRes.Package[0].Code + "</PackageCode>");
        sb.Append("<PackageLabel>" + inqueryRes.Package[0].Label + "</PackageLabel>");
        sb.Append("<DurationCode>" + inqueryRes.Duration[0].Code + "</DurationCode>");
        sb.Append("<DurationLabel>" + inqueryRes.Duration[0].Label + "</DurationLabel>");
        sb.Append("<Amount>" + inqueryRes.PackageAmount + "</Amount>");
        sb.Append("<TotalAmount>" + inqueryRes.TransactionAmount + "</TotalAmount>");
        sb.Append("<AgentFee>" + inqueryRes.ServiceFee + "</AgentFee>");
        sb.Append("<SessionID>" + inqueryRes.SessionID + "</SessionID>");
    ...
    public static string getConfirmResSolarHome(SolarHomeConfirmResponse confirmRes)
    {
        ...
        sb.Append("<Ref1>" + confirmRes.Amount + "</Ref1>");
        sb.Append("<Ref5>" + confirmRes.Mobile + "</Ref5>");
        sb.Append("<Ref5Name>Mobile No</Ref5Name>");
        sb.Append("<TodayTxnCount>" + confirmRes.TodayTxnCount + "</TodayTxnCount>");
        sb.Append("<TodayTxnAmount>" + confirmRes.TodayTxnAmount + "</TodayTxnAmount>");
    ...
    public static string getErrorRes(string code,string desp)
    {
        ...
        sberror.Append("<ResDesc>" + desp + "</ResDesc>");
        sberror.Append("</Error>");
    ...
    public static string GetFtthOrWtthInquiryList(FtthOrWtthInquiryResponse inqueryRes)
    {
        ...
        sb.Append("<CustomerName>" + inqueryRes.InquiryDetails.CustomerName + "</CustomerName>");
        sb.Append("<PlanType>" + inqueryRes.InquiryDetails.PlanType + "</PlanType>");
        sb.Append("<Plans>");
        foreach (var plan in inqueryRes.InquiryDetails.Plans)
        {
            sb.Append("<Plan>");
    ...
    public static string GetMptDataPackageInquiryList(MptDataPackageInquiryResponse inqueryRes)
    {
        ...
        sb.Append("<DataPacks>");
        //foreach (var plan in inqueryRes.PackageDetails.Detail.PackageLists)
        //{
        //    sb.Append("<DataPack>");
    ...
    //public static string GetFtthOrWtthConfirmList(FtthOrWtthConfirmResponse inqueryRes)
    //{
    //    StringBuilder sbLog = new StringBuilder();
    //    StringBuilder sb = new StringBuilder();

    //    sb.Append("<FtthOrWtthConfirmResponse>");
    //    sb.Append("<Version>1.0</Version>");
    //    sb.Append("<Version>" + inqueryRes.ResCode + "</Version>");
    //    sb.Append("<TimeStamp>" + System.DateTime.Now.ToString("yyyyMMddhhmmssffff") + "</TimeStamp>");
    //    sb.Append("<ResCode>" + inqueryRes.ResCode + "</ResCode>");
    //    sb.Append("<ResDesc>" + inqueryRes.ResDesc + "</ResDesc>");
    //    sb.Append("<TaxID>" + inqueryRes.taxID + "</TaxID>");
    ...
    //        foreach (var pack in plan.Packs)
    //        {
    //            sb.Append("<Devices>" + pack.Price + "</Devices>");
    //            sb.Append("<ExpiredOn>" + pack.Description + "</ExpiredOn>");
    //        }
    //        sb.Append("</Packs>");
    //    }
    //    sb.Append("</Plans>");
    //    sb.Append("<ResponseCode>" + inqueryRes.InquiryDetails.ResponseCode + "</ResponseCode>");
    //    sb.Append("<ResponseDescription>" + inqueryRes.InquiryDetails.ResponseCode + "</ResponseDescription>");
    //    sb.Append("</InquiryDetails>");
    //    sb.Append("</FtthOrWtthConfirmResponse>");
    //    return sb.ToString();
    //}
    ...
    {
        //string result = sourceString.Substring(sourceString.Length - plainTextLength).PadLeft(sourceString.Length, maskCharacter);
